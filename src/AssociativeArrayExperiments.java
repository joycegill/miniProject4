...
import structures.ReportingAssociativeArray;
...
public class AssociativeArrayExperiments {
   ...
   * @throws KeyNotFoundException
   */
  public static void expreimentStringsToStrings(PrintWriter pen) throws KeyNotFoundException {
   ...
   * @throws KeyNotFoundException
   */
  public static void experimentBigIntToBigInt(PrintWriter pen) throws KeyNotFoundException {
